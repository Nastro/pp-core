...
## [3.1.10] 2026-02-17
- Обновление безопасности `PropertiesModule` и `AuditLogModule`

## [3.1.9] 2026-02-16
- Динамическая загрузка CAPTCHA для формы логина админ панели

## [3.1.8] 2026-02-11
- Хотфиксы для 3.1.7

## [3.1.7] 2026-02-10
- Добавлена детализация в описаниях при логировании параметров
- Доработано логирование параметров консольной командой

## [3.1.6] 2026-02-09
- Исправлено сломанное поведение в драйвере кэша Redis
- Исправлена обработка CRON-очереди, если джоба бросает исключения внутренних ошибок PHP
- Доработано логирование изменения системных параметров

## [3.1.5] 2025-04-15
- Исправлена проблема кэша в AuditLogger

## [3.1.4] 2025-04-03
- Рефакторинг ErrorReporter

## [3.1.3] 2025-03-28
- Исправлена ошибка при null значении хэша пароля в БД

## [3.1.2] 2025-03-26
- Удалена устаревшая ссылка на magic базу данных

## [3.1.1] 2025-03-13
- Исправлена ошибка в определении текущего элемента в Dropdown списках

## [3.1.0] 2025-03-12
- Обновлена версия php до 8.4
